...
@WebServlet(name = "PhoneBookServer",urlPatterns = "/phonebook/*")
public class PhoneBookServer extends HttpServlet {
    ...
    private void forwardTo(HttpServletRequest request , HttpServletResponse response, String routs) throws ServletException, IOException{
        ServletContext context = getServletContext();
        RequestDispatcher rd = context.getRequestDispatcher(routs);
